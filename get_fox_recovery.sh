...
DEVICE_BRANCH="herolte"; # device tree branch, default is fox_12.1
DEVICE_TREE_URL="https://github.com/Vinylsmith/android_device_samsung_hero.git"; # device tree url, default is for miatoll
LOCAL_DEVICE_TREE_URL="git@github.com:Vinylsmith/android_device_samsung_hero.git"; # local device tree url, default is for miatoll
...
test_build_device="herolte"; # default is miatoll

# are we building for a virtual A/B (VAB) device?  (default is "no")
[ -z "$FOX_OMNI_DEVICE" ] && FOX_OMNI_DEVICE="1"; # default is 0
